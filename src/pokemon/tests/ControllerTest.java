...
public class ControllerTest
{
	...
	{
		assertNotNull("You need an instance of PokemonFrame", testedController.getPokemonFrame());
		assertTrue("Your baseFrame needs to be of type PokemonFrame", testedController.getPokemonFrame() instanceof PokemonFrame);
	}
